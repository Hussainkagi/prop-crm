...
export default function EditUserPage({
  ...
  const [formData, setFormData] = useState({
    ...
    email_id: dummyUser.email_id,
    first_name: dummyUser.first_name,
    last_name: dummyUser.last_name,
    mobile_number: dummyUser.mobile_number,
    employee_code: dummyUser.employee_code,
    role_id: dummyUser.role_id,
    department: dummyUser.department,
    designation: dummyUser.designation,
    user_status: dummyUser.user_status,
  });
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update username and email for the user
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update role, department and designation
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
